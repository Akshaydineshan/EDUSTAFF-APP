...
@Component({
  selector: 'app-retired-teacher-list',
  templateUrl: './retired-teacher-list.component.html',
  styleUrls: ['./retired-teacher-list.component.scss'],
  providers: [DatePipe]
})
export class RetiredTeacherListComponent {
  ...
  loadTableDataList() {
    let tableDataListApiEndPoint: string = 'Teacher/GetAllRetiredTeacher'
