...
@Component({
  selector: 'app-staff-transfer-completed-list',
  templateUrl: './staff-transfer-completed-list.component.html',
  styleUrls: ['./staff-transfer-completed-list.component.scss'],
  providers: [DatePipe]
})
export class StaffTransferCompletedListComponent {
  ...
  loadTableDataList() {
    let tableDataListApiEndPoint: string = '/TransferRequest/GetAllTransferedNonTeacher'
