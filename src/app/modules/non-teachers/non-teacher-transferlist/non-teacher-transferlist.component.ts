...
@Component({
  selector: 'app-non-teacher-transferlist',
  templateUrl: './non-teacher-transferlist.component.html',
  styleUrls: ['./non-teacher-transferlist.component.scss'],
  providers: [DatePipe]
})
export class NonTeacherTransferlistComponent implements OnInit {
