...
@Component({
  selector: 'app-staff-section-view',
  templateUrl: './staff-section-view.component.html',
  styleUrls: ['./staff-section-view.component.scss']
})
export class StaffSectionViewComponent {
