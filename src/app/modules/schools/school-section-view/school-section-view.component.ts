...
@Component({
  selector: 'app-school-section-view',
  templateUrl: './school-section-view.component.html',
  styleUrls: ['./school-section-view.component.scss']
})
export class SchoolSectionViewComponent {
